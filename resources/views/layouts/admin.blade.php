...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Sistema de gestion </span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('admin/img/avatar.jpg')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('admin/img/avatar.jpg')}}" class="user-image" alt="User Image">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class=""></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('dependencias') }}"><i class="fa fa-tags"></i> Dependencias</a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="http://oferta.senasofiaplus.edu.co/sofia-oferta/">SENA </a>.</strong> All rights
        reserved.
    </footer>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{asset('admin/js/boosotstrap.min.js')}}"></script>
<!-- FastClick -->
